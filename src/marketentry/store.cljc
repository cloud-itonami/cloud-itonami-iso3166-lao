(ns marketentry.store
  "SSoT for the Lao People's Democratic Republic (LAO) market-entry
  compliance actor, behind a `Store` protocol so the backend is a swap,
  not a rewrite -- the same seam every prior cloud-itonami actor in this
  fleet uses.
...
(defn demo-data
  ...
  `:land-concession-hectares` / `:relocated-households` /
  `:claimed-legislative-approval` are ground truth for the
  `legislative-approval-mismatch` flagship check (Law on Investment
  Promotion (Amended) Arts.49-50 National Assembly / Provincial People's
  Assembly tiers); `:requires-enterprise-registration?` /
  `:enterprise-registration-verified?` are ground truth for the
  conditional enterprise-registration-certificate check (which, per
  investlaos.gov.la's own FAQ, also bundles Tax Identification Number
  issuance -- see `marketentry.facts`)."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Vientiane Manufacturing Co., Ltd." :portal "OISO / Department of Enterprise Management"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :land-concession-hectares 50 :relocated-households 0
             :claimed-legislative-approval nil
             :requires-enterprise-registration? true :enterprise-registration-verified? true
             :drafted? false :submitted? false
             :jurisdiction "LAO" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "OISO / Department of Enterprise Management"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :land-concession-hectares 50 :relocated-households 0
             :claimed-legislative-approval nil
    ...
    "eng-3" {:id "eng-3" :operator "Champasak Concession Co., Ltd." :portal "OISO / Department of Enterprise Management"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 999000.0
             :land-concession-hectares 200 :relocated-households 20
             :claimed-legislative-approval nil
             :requires-enterprise-registration? true :enterprise-registration-verified? true
             :drafted? false :submitted? false
             :jurisdiction "LAO" :status :intake}
    "eng-4" {:id "eng-4" :operator "Bolikhamxay Land Concession EAIC" :portal "OISO / Department of Enterprise Management"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "LAO" :status :intake}
    "eng-5" {:id "eng-5" :operator "Savannakhet Logistics Sole Co., Ltd." :portal "OISO / Department of Enterprise Management"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :land-concession-hectares 50 :relocated-households 0
             :claimed-legislative-approval nil
             :requires-enterprise-registration? true :enterprise-registration-verified? false
             :drafted? false :submitted? false
             :jurisdiction "LAO" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               land-concession-hectares relocated-households claimed-legislative-approval
                               requires-enterprise-registration? enterprise-registration-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    land-concession-hectares                   (assoc :engagement/land-concession-hectares land-concession-hectares)
    (some? relocated-households)               (assoc :engagement/relocated-households relocated-households)
    claimed-legislative-approval                (assoc :engagement/claimed-legislative-approval claimed-legislative-approval)
    (some? requires-enterprise-registration?)  (assoc :engagement/requires-enterprise-registration? requires-enterprise-registration?)
    (some? enterprise-registration-verified?)  (assoc :engagement/enterprise-registration-verified? enterprise-registration-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/land-concession-hectares :engagement/relocated-households :engagement/claimed-legislative-approval
   :engagement/requires-enterprise-registration? :engagement/enterprise-registration-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :land-concession-hectares (:engagement/land-concession-hectares m)
     :relocated-households (:engagement/relocated-households m)
     :claimed-legislative-approval (:engagement/claimed-legislative-approval m)
     :requires-enterprise-registration? (boolean (:engagement/requires-enterprise-registration? m))
     :enterprise-registration-verified? (boolean (:engagement/enterprise-registration-verified? m))
