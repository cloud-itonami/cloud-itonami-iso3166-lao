(ns marketentry.phase
  "Phase 0->3 staged rollout for the Lao People's Democratic Republic
  (LAO) market-entry compliance actor.
  ...
  real investment-license/enterprise-registration filing package and
  ...
  `marketentry.governor`'s `:actuation/draft-filing`/`:actuation/submit-
  filing` high-stakes gate enforces the same invariant independently --
